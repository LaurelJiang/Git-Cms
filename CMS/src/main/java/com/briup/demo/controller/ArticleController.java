 ...
 */
@RestController
@Api(description="文章信息相关的接口")
public class ArticleController {
	@Autowired
	private IArticalService articleService;
	...
	@PostMapping("/deletArticleById")
	@ApiOperation("更具id删除文章")
	public Message<String> deleteArticleById(int id){
		articleService.deleteArticleById(id);
		return MessageUtil.success();
	}
	
	@PostMapping("/findArticleByCondition")
	...
	public Message< Article> getArticleByCondition(int id){
